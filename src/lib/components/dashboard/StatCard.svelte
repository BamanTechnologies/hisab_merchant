<script lang="ts">
  ...
  let { value, label, iconBg, iconColor, icon: Icon, loading = false }: Props = $props();
</script>

<article class="rounded-xl bg-white p-5 shadow-sm ring-1 ring-gray-100 transition hover:shadow-md dark:bg-[#0f172a] dark:ring-white/10">
