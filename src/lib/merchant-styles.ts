...
export const mc = {
  ...
  tdRight:
    "border-b border-gray-100 px-4 py-2 text-right align-middle text-sm text-gray-700 dark:border-white/5 dark:text-gray-300",
  tdCenter:
    "border-b border-gray-100 px-4 py-2 text-center align-middle text-sm text-gray-700 dark:border-white/5 dark:text-gray-300",
  colNum:
  ...
  rowClickable:
    "cursor-pointer transition hover:bg-gray-50/80 dark:hover:bg-white/5",
  emptyCell:
...
export function customerStatusChipClass(
